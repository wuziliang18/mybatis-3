...
public final class TypeHandlerRegistry {
	...
	public TypeHandlerRegistry() {
		...
		register(Byte[].class, JdbcType.LONGVARBINARY,
				new BlobByteObjectArrayTypeHandler());
	...
	public boolean hasTypeHandler(Class<?> javaType, JdbcType jdbcType) {
		return javaType != null
				&& getTypeHandler((Type) javaType, jdbcType) != null;
	}
	...
	// Only handler
	/**
	 * 注册TypeHandler 尝试从MappedTypes注解或者自带泛型（TypeReference接口实现）中获取java的类型
	 * 如果没有注册key为null
	 * 
	 * @param typeHandler
	 */
	...
	public <T> void register(TypeHandler<T> typeHandler) {
		...
		MappedTypes mappedTypes = typeHandler.getClass().getAnnotation(
				MappedTypes.class);
		if (mappedTypes != null) {
		...
		// 根据TypeHandler的实现类获取类型(实现了TypeReference)
	...
	private <T> void register(Type javaType,
			TypeHandler<? extends T> typeHandler) {
		MappedJdbcTypes mappedJdbcTypes = typeHandler.getClass().getAnnotation(
	...
	public <T> void register(Class<T> type, JdbcType jdbcType,
			TypeHandler<? extends T> handler) {
	...
	public void register(Class<?> javaTypeClass, JdbcType jdbcType,
	...
	public Collection<TypeHandler<?>> getTypeHandlers() {
		return Collections.unmodifiableCollection(ALL_TYPE_HANDLERS_MAP
				.values());
	}
